...
class AssemblyCli:
    ...
    def createArgParser() -> ArgumentParser:
        ...
        parser = ArgumentParser(
            prog="python3 -m py-isa-m68k.as",
            description="Whatever.",
            epilog="""---
(c) 2024 David SPORN
---
This is part of py-isa-m68k -- Sporniket's toolbox for the m68k instruction set architecture.
...
""",
    ...
    def run(self):
        try:
            args = AssemblyCli.createArgParser().parse_args()
